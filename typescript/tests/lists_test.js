...
(function (ListsTest) {
    ...
    describe('#isPalindrome', () => {
        it('should work any list of strings', () => {
            fast_check_1.default.assert(fast_check_1.default.property(fast_check_1.default.array(fast_check_1.default.string()), arr => {
                expect(L.isPalindrome(arr)).equal(arr.reverse);
            }));
        });
        it('should work any list of lists', () => {
            fast_check_1.default.assert(fast_check_1.default.property(fast_check_1.default.array(fast_check_1.default.array(fast_check_1.default.double())), arr => {
                expect(L.isPalindrome(arr)).equal(arr.reverse);
            }));
        });
    });
